...
@Component({
    ...
    template: ` <div class="layout-sidebar" (mouseenter)="onMouseEnter()" (mouseleave)="onMouseLeave()">
        <div class="layout-sidebar-top">
            <a href="/">
                <svg width="100" viewBox="0 0 64 21" fill="none" xmlns="http://www.w3.org/2000/svg" class="layout-sidebar-logo">
                ...
                <svg width="40px" height="40px" viewBox="0 0 263 237" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="layout-sidebar-logo-slim">
                    <defs>
                        <path
                    ...
                    <g id="Avalon-Theme" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="logo-type---1" transform="translate(-589.000000, -88.000000)">
                            <g id="avalon-logo-icon" transform="translate(589.000000, 88.000000)">
                                <g id="sword" transform="translate(128.894444, 110.300036) rotate(-225.000000) translate(-128.894444, -110.300036) translate(51.394444, 32.800036)" fill="var(--topbar-item-text-color)" fill-rule="nonzero">
                                    <path
                                ...
                                <g id="avalon-mountain" transform="translate(0.000000, 140.000000)">
                                    ...
                                    <use id="Path-2" fill="var(--topbar-item-text-color)" xlink:href="#path-1"></use>
                                    <polygon
                                        id="Path-5"
                                        fill="var(--topbar-item-text-color)"
                                        mask="url(#mask-2)"
